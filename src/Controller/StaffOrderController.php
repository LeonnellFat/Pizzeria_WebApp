...
final class StaffOrderController extends AbstractController
{
    ...
    #[Route('/new', name: 'app_staff_order_new', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}/edit', name: 'app_staff_order_edit', methods: ['GET', 'POST'])]
    public function edit(Request $request, Order $order, EntityManagerInterface $entityManager): Response
    {
        // Check if staff owns this order (only staff can edit orders they created)
    ...
    #[Route('/{id}', name: 'app_staff_order_delete', methods: ['POST'])]
    public function delete(Request $request, Order $order, EntityManagerInterface $entityManager): Response
    {
        // Check if staff owns this order (only staff can delete orders they created)
        if ($order->getCreatedBy() !== $this->getUser()) {
    ...
    #[Route('/{id}/status', name: 'app_staff_order_update_status', methods: ['POST'])]
