...
final class MyProfileAdminController extends AbstractController
{
    ...
    public function index(): Response
    {
        ...
        return $this->render('myprofile_admin/index.html.twig', [
            'user' => $user,
        ]);
    }
    ...
    public function editUsername(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('myprofile_admin/edit_username.html.twig', [
            'user' => $user,
            'form' => $form,
        ]);
    }
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            try {
                ...
                if (!$passwordHasher->isPasswordValid($user, $currentPassword)) {
                    ...
                    return $this->render('myprofile_admin/change_password.html.twig', [
                        'form' => $form,
                    ]);
                }
